...
# DONT USE THIS PROGRAM - big broken
# Used to work at one time but will be porting to winforms

global menuState

ssl._create_default_https_context = ssl._create_unverified_context

destination = "G:/Media/4Chan"
w, h = 400, 600
